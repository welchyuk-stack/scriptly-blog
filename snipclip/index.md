    ...
    <div>
      ...
      <div class="app-hero__text">
        ...
        <div class="app-hero__btn-row">
          ...
          <span class="app-hero__price">${{ site.sections.snipclip.price }} one-time · macOS 13+</span>
        </div>
      </div>
    </div>
...
<div class="feat-grid" style="--app-tint: {{ site.sections.snipclip.tint }};">
  ...
  <div class="feat"><div class="k">Price</div><h3>${{ site.sections.snipclip.price }} one-time</h3><p>No subscription, no trial, no in-app purchases. Requires macOS 13+.</p></div>
</div>
