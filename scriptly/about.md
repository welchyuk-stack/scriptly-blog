...
Scriptly makes Mac automation accessible to everyone.

## The Problem

Repetitive Mac tasks waste hours every week:
- Organizing emails
- Renaming files in bulk
- Moving downloads to folders
- Syncing data between apps

Most automation tools require coding. We're solving that.
...
<a href="https://apps.apple.com/us/app/scriptly-script-automations/id6788839033?mt=12"><img src="{{ '/assets/images/badges/app-store-badge-black.svg' | relative_url }}" width="120" height="40" alt="Download on the App Store" style="height: 44px; width: auto;"></a>
...
- GitHub: [scriptly-blog](https://github.com/welchyuk-stack/scriptly-blog)
